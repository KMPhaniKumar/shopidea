...
- **catalog/products & stores:** create/update/delete with **ownership checks** (non-owner → 403 — see the IDOR findings in `agents_reports/SECURITY_AUDIT.md`), validation (400), public store endpoints must NOT leak KYC columns.
