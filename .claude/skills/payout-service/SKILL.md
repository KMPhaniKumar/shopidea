...
## Gotchas / risks
- **RazorpayX payout execution is not fully wired yet** — confirm current state in `agents_reports/AUDIT_gaps.md` before assuming payouts actually disburse.
...
See `agents_reports/SECURITY_AUDIT.md` (bank-account IDOR), `agents_reports/AUDIT_gaps.md`, `payment-service` skill.
