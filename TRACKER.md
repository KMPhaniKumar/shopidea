...
- Backend migrated **ECS EC2 → ECS Fargate** (all 10 services), reconciled into **Terraform** (`reelmart-infra/infra/terraform/`); EC2 ASG/capacity-provider/instance-TGs decommissioned. Live & verified via ALB.
