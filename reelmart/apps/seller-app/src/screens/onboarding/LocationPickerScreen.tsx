...
import { PickedLocation } from '../../navigation/types'
    ...
    <View style={styles.container}>
      ...
      <View style={styles.bottomCard}>
        {resolving ? (
          ...
          <Text style={styles.resolveHint}>Drag the map to select a location</Text>
        )}
...
const styles = StyleSheet.create({
  ...
  pinContainer: {
    ...
    // offset upward by half the bottom card height so pin is on the map center
    marginBottom: 160,
  },
  pin: { fontSize: 36 },
  pinShadow: {
