...
export default function ProductClient({ product, storeSlug }: { product: Product; storeSlug: string }) {
  ...
  // Add / quantity / checkout controls — reused in the desktop side panel and
  // the mobile sticky footer.
  ...
  return (
    <div className="min-h-screen bg-[#F9F9F9]">
      ...
      <div className="max-w-6xl mx-auto lg:px-6 pb-32 lg:pb-12">
        <div className="lg:grid lg:grid-cols-2 lg:gap-10 lg:py-6 lg:items-start">
          {/* LEFT — image gallery (sticky on desktop) */}
          <div className="lg:sticky lg:top-24">
            <div className="bg-white overflow-hidden lg:rounded-2xl lg:border lg:border-gray-200">
          ...
          <div className="lg:min-w-0">
            {/* Title + price */}
            <div className="bg-white mt-2 lg:mt-0 px-4 py-5 lg:rounded-2xl lg:border lg:border-gray-200">
              <h2 className="text-xl lg:text-2xl font-black text-[#1A1A1A] mb-2 leading-tight">{product.name}</h2>
              <div className="flex items-baseline gap-3 mb-3">
                <span className="text-2xl lg:text-3xl font-black text-[#1A1A1A]">₹{product.price}</span>
              ...
              {/* Desktop action controls (mobile uses the sticky footer) */}
            ...
            {/* Store card */}
            <Link href={`/store/${store.store_slug}`} className="block bg-white mt-2 px-4 py-4 lg:rounded-2xl lg:border lg:border-gray-200 hover:bg-gray-50 transition">
            ...
            {!store.is_open && (
              <div className="mx-4 lg:mx-0 mt-2 bg-red-50 border border-red-200 rounded-xl px-4 py-3 text-sm text-red-700">
      ...
      {/* Sticky footer — mobile only (desktop uses the inline controls) */}
      <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 shadow-2xl lg:hidden">
