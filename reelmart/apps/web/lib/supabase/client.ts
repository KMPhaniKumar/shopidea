...
// setSession() on one instance (e.g. the test-login "Skip" button) isn't seen
// by another instance's getUser() (e.g. the home BuyerAuthNav) without a full
// page reload. Sharing one instance makes auth state propagate in-page.
